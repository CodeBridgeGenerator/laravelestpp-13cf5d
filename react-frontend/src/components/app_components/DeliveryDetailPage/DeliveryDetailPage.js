...
rounded loading={loading} icon="pi pi-plus" onClick={() => setShowCreateDialog(true)} role="deliveryDetail-add-button"/>
                    
                    </>
                </div>
            </div>
            <div className="grid align-items-center">
                <div className="col-11" role="deliveryDetail-datatable">
...
/>            
      ...
      />
            ...
            <DeliveryDetailCreateDialogComponent entity={newRecord} onCreateResult={onCreateResult} show={showCreateDialog} onHide={() => setShowCreateDialog(false)}  />
