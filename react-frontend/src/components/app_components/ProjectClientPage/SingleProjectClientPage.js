...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">is_active</label><p className="m-0 ml-3" >{_entity?.isActive}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">updated_at</label><p className="m-0 ml-3" >{Number(_entity?.updatedAt)}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleProjectClientId}
        user={props.user}
        alert={props.alert}
