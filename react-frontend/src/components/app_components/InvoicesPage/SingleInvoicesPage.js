...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">invoice_date</label><p className="m-0 ml-3" >{Number(_entity?.invoiceDate)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">created_by</label><p className="m-0 ml-3" >{_entity?.createdBy}</p></div>
