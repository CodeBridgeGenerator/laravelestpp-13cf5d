...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">type</label><p className="m-0 ml-3" >{Number(_entity?.type)}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">image</label><p className="m-0 ml-3" >{_entity?.image}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">updated_at</label><p className="m-0 ml-3" >{_entity?.updatedAt}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleCategoriesId}
        user={props.user}
        alert={props.alert}
