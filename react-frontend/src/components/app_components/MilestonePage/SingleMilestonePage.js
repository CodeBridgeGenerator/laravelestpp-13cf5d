  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">project_id</label><p className="m-0 ml-3" >{Number(_entity?.projectId)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">progress</label><p className="m-0 ml-3" >{Number(_entity?.progress)}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">start_date</label><p className="m-0 ml-3" >{Number(_entity?.startDate)}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">end_date</label><p className="m-0 ml-3" >{Number(_entity?.endDate)}</p></div>
