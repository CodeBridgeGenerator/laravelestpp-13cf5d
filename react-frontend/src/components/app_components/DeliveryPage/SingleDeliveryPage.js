...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">attachment_path</label><p className="m-0 ml-3" >{_entity?.attachmentPath}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">delivery_status</label><p className="m-0 ml-3" >{_entity?.deliveryStatus}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">delivery_date</label><p className="m-0 ml-3" >{Number(_entity?.deliveryDate)}</p></div>
