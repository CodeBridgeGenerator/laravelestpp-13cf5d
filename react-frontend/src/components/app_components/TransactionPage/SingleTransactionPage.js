...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">debit</label><p className="m-0 ml-3" >{Number(_entity?.debit)}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">credit</label><p className="m-0 ml-3" >{_entity?.credit}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">updated_at</label><p className="m-0 ml-3" >{Number(_entity?.updatedAt)}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleTransactionId}
        user={props.user}
        alert={props.alert}
