...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">vendor_id</label><p className="m-0 ml-3" >{Number(_entity?.vendorId)}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">warehouse_id</label><p className="m-0 ml-3" >{Number(_entity?.warehouseId)}</p></div>
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">purchase_type</label><p className="m-0 ml-3" >{_entity?.purchaseType}</p></div>
...
<div className="col-12 md:col-6 lg:col-3 mb-10"><label className="text-sm text-gray-600">created_by</label><p className="m-0 ml-3" >{Number(_entity?.createdBy)}</p></div>
