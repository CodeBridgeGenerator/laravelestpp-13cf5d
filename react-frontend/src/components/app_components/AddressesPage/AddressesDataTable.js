...
const pTemplate15 = (rowData, { rowIndex }) => <p >{rowData.updatedAt}</p>
  ...
  const handleHideDialog = () => {
    ...
    return (
        ...
        />
<Column field="customerId" header="customer_id" body={dropdownTemplate0} filter={selectedFilterFields.includes("customerId")} hidden={selectedHideFields?.includes("customerId")}  style={{ minWidth: "8rem" }} />
