                ...
                },
{
                  ...
                  menuKey: "vendorAddress",
                  to: "/vendorAddress",
                },
{
                  icon: <Home />,
                  label: "Product Services",
                  menuKey: "productServices",
                  to: "/productServices",
                },
{
                  icon: <Home />,
                ...
                },
{
                  ...
                  menuKey: "deliveryDetail",
                  to: "/deliveryDetail",
                },
{
                  icon: <Home />,
                  label: "Delivery Method",
                  menuKey: "deliveryMethod",
                  to: "/deliveryMethod",
                },
{
                  icon: <Home />,
                  label: "Invoice Template",
                  menuKey: "invoiceTemplate",
                  to: "/invoiceTemplate",
                },
{
                  icon: <Home />,
                ...
                },
{
                  ...
                  menuKey: "purchaseProduct",
                  to: "/purchaseProduct",
                },
{
                  icon: <Home />,
                  label: "Purchase Type",
                  menuKey: "purchaseType",
                  to: "/purchaseType",
                },
{
                  icon: <Home />,
                  label: "Purchase Payment",
                  menuKey: "purchasePayment",
                  to: "/purchasePayment",
                },
{
                  icon: <Home />,
                ...
                },
{
                  ...
                  menuKey: "projectClient",
                  to: "/projectClient",
                },
{
                  icon: <Home />,
                  label: "Project Attachment",
                  menuKey: "projectAttachment",
                  to: "/projectAttachment",
                },
                                    /* ~cb-add-menu~ */
                                ]
                            }
